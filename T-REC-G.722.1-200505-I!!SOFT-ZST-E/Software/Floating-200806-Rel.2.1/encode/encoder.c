...
extern const int differential_region_power_bits[MAX_NUM_REGIONS][DIFF_REGION_POWER_LEVELS];
extern const int differential_region_power_codes[MAX_NUM_REGIONS][DIFF_REGION_POWER_LEVELS];
extern const int table_of_bitcount_tables[NUM_CATEGORIES-1];
extern const int table_of_code_tables[NUM_CATEGORIES-1];
...
extern const int max_bin[NUM_CATEGORIES];
