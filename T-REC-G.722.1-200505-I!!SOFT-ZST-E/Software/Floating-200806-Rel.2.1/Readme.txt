             ==============================================
             ITU-T Recommendation G.722.1 Annex B (06/2008)
                     C-Source Code and Test Vectors
                              Release 2.1
             ==============================================

This folder contains the C code and test vectors for the floating point 
implementation of 7 kHz mode of the G.722.1 compression algorithm 
approved 2000-11, including the correction described in G.722.1 Implementors'
Guide approved 2002-10. It does *not* include the 14 kHz mode approved 2005-05.


COPYRIGHT AND INTELLECTUAL PROPERTY
===================================
**   (c) 2000 PictureTel Coporation
**          Andover, MA, USA  
**
**	    All rights reserved.
...
The test vectors in this directory consist of input and output
...
Note: 	Floating point implementations on different platforms 
	...
	are provided as a reference. Some other type of criteria such
	as segment SNR can be used to validate implementations.



Warning:  Successfully passing the test vectors does not guarantee 
          full compliance with this recommendation. This is because
          the test vectors do not exercise every state and line of the
          code.
